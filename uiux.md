...
| 항목 | 내용 |
|------|------|
| **입력** | **영어 문장** + **문장 뜻**(수동 입력, AI 미사용) → **문장으로 나누기** · 영어·한글 문장 수·순서를 맞춤 · 영어 단어 2개 이하 문장은 다음 문장과 합침 · **여는 따옴표~닫는 따옴표는 한 문장** · 닫는 따옴표 뒤 `라고`/`솔직하게 말해`/`she said`도 같은 문장 (`"It's already 7:30. Oops! I'm late."`) |
...
| 팝업 **문장으로 나누기** | 영어·문장 뜻을 문장 단위로 분리해 2단계 표시 · 영어 단어 2개 이하(`Hi!`)는 다음 문장과 합치고 한글 뜻도 같이 붙임 · **여는 따옴표~닫는 따옴표는 한 문장** · 닫는 따옴표 뒤 `라고`/`솔직하게 말해`/`she said`도 같은 문장 (이동 없음) |
