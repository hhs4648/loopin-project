    ...
    */
    stops: [
      ...
      },
      {
        ...
        body: "학년·교과서·단원을 차례로 고르면 그 단원 단어가 아래에 뜹니다. 단원까지 골라야 다음으로 넘어가요.",
        advance: "confirm",
        notReadyLabel: "단원까지 골라 주세요",
      },
      /*
        **본문은 범위 바로 다음에 짚는다.** 교과서 본문은 저작권 때문에 미리 싣지
        않아서(문장 문항이 0개다) 선생님이 넣어야 비로소 문장 문제가 생긴다. 나중에
        「유형」에서 청크배열을 켜 놓고 아무것도 안 나가는 것보다, 여기서 먼저
        「넣으면 이런 게 생긴다」를 보여 주는 편이 낫다.

        대신 **건너뛸 수 있게 둔다**(`optional`) — 첫 사용에서 지문까지 준비해 오는
        선생님은 드물고, 단어만으로도 과제는 나간다.
      */
      {
        id: "passage",
        anchor: "problem-passage",
        title: "본문과 본문 뜻을 넣어 주세요",
        body: "교과서 지문을 넣으시길 권해요. 저작권 때문에 본문은 미리 넣어 두지 않아서, 선생님이 붙여 넣어야 문장 문제가 만들어집니다. 「문장으로 나누기」를 누르면 문장 단위로 쪼개져 문항이 돼요. 비워 두면 단어 문제만 낼 수 있어요.",
        advance: "optional",
      },
      {
        id: "classes",
      ...
      },
      {
        ...
        body: "유형은 처음부터 전부 켜져 있어요. 빼고 싶은 것만 끄면 됩니다. 아래 목록에 문항이 없는 유형은 켜 두어도 안 나가니, 목록을 보고 고르세요. 그 아래에서 낼 문항을 고르세요 — 고른 유형만 학생 앱에 나갑니다.",
        advance: "confirm",
